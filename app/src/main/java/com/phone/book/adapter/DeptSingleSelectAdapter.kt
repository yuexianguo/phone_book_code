 ...
 * date : 2021/1/26
 */
abstract class DeptSingleSelectAdapter<T>(list: List<T>) : CustomBaseAdapter<T, DeptSingleSelectAdapter<T>.SingleSelectHolder>(R.layout.dept_adapter_item_single_selector, list) {
